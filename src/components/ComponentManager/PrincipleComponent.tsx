...
const PrincipleComponent = ({
  ...
  return (
    <div
      ...
      className="w-full flex justify-between items-start py-5 md:py-10 border-b border-[#535353] cursor-pointer"
    >
      <div className="flex justify-start items-start gap-5 md:gap-10 w-full">
        <div className="w-10 h-10 md:w-16 md:h-16 bg-gradient-to-r from-[#535353] to-[#C1C1C1] flex justify-center items-center font-gte font-bold text-[20px] sm:text-[24px] text-white">
          {index + 1}.
        </div>
