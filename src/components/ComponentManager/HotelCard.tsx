...
const HotelCard = ({
  ...
  return (
    <div className="w-full flex flex-col justify-start items-center px-6 md:px-10 pt-6 md:pt-10 pb-3   bg-[#F9F8FA] gap-5 sm:gap-5 lg:gap-7">
      <div className="max-w-[212px] h-[132px] w-full flex justify-center items-center bg-gradient-to-r from-[#535353] to-[#C1C1C1] shadow-[0_8px_16px_0_rgba(0,0,0,0.16),0_16px_32px_0_rgba(0,0,0,0.16)] rounded-lg mb-3">
        {percentage && (
