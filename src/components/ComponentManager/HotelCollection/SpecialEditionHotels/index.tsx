          ...
          {buttons?.map((button, index) => {
            return (
              <button
                ...
                className={`flex gap-2 items-center pb-3 px-3 border-[#535353] group ${
                  index == idx ? "border-b-2" : "border-none"
                }`}
              >
                <h2
                  className={`font-montserrat font-semibold  leading-[24px] group-hover:text-[#535353] duration-200 ${
                    index == idx
                      ? "text-[#535353] text-[20px] sm:text-[22px]"
                      : "text-[18px]"
                  }`}
                >
                  {button.title}
                ...
                <div
                  className={`w-6 h-6 flex justify-center items-center rounded-sm text-[15px] font-montserrat font-semibold group-hover:text-white group-hover:bg-gradient-to-r from-[#535353] to-[#C1C1C1] duration-200 ${
                    index == idx
                      ? "bg-gradient-to-r from-[#535353] to-[#C1C1C1] text-white"
                      : "bg-[#f0f0f0] "
                  }`}
                >
                  {button.length}
