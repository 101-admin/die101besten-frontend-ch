          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 relative">
            ...
            <div className="w-full flex flex-col justify-start items-baseline">
              ...
              <Link
                ...
                className="flex items-center gap-3 group text-black hover:bg-gradient-to-l from-[#C1C1C1] to-[#535353] hover:text-transparent hover:bg-clip-text cursor-pointer"
              >
                <MdOutlineMailOutline className="text-[22px] group-hover:text-[#535353]" />
                    ...
                    <div key={index}>
                      {item?.newTab ? (
                        <Link key={index} target="_blank" href={`${item?.url}`}>
                          <li className="text-[14px] font-light font-gte   hover:text-[#535353] cursor-pointer">
                            {item?.label}
                          </li>
                        </Link>
                      ) : (
                ...
                <div key={index}>
                  {item?.label === "Cookies" ? (
                    <Link href="#" data-cc="c-settings">
                      <div className="text-[14px] font-light font-gte   hover:text-[#535353] cursor-pointer">
                        {item?.label}
                      </div>
                    </Link>
                  ) : (
