...
const NavbarContent = ({ navbar }) => {
  ...
  const [editionIndex, setEditionIndex] = useState(2);
                  ...
                  >
                    {hasSubmenu ? (
                      <li
                        ...
                        className="font-gte mt-3 w-full px-3 text-[18px] uppercase font-[350] leading-[24px] border-b border-black pb-2 hover:text-[#535353] hover:border-[#535353]"
                      >
                      ...
                      <Link
                        ...
                        href={`${url}`}
                      >
                        <li className="font-gte mt-3 w-full px-3 text-[18px] uppercase font-[350] leading-[24px] border-b border-black pb-2 hover:text-[#535353] hover:border-[#535353]">
                          {label}
                        </li>
                      </Link>
                    )}
                            ...
                            {links?.map((navitem, index) => {
                              return (
                                <Link
                                  ...
                                  onClick={() => setBarBtn(true)}
                                  key={index}
                                  className="text-[14px] font-gte font-light hover:text-[#535353]"
                                >
                                  {navitem?.label}
                                </Link>
                              );
                ...
                <div className="h-full" key={index}>
                  {hasSubmenu ? (
                    <h1
                      ...
                      className={`text-[16px] font-bold font-montserrat uppercase leading-[24px] hover:text-[#535353] cursor-pointer h-full flex justify-center items-center px-4 ${
                        menu === true
                          ? "text-[#535353] bg-[#F9F8FA]"
                    ...
                    <Link href={`${url}`}>
                      <button className="text-[16px] h-full flex justify-center items-center font-bold font-montserrat uppercase leading-[24px] hover:text-[#535353] px-4 cursor-pointer">
                        {label}
                      </button>
                    </Link>
                  )}
            ...
            >
              <button
                ...
                className={`flex h-full px-3 justify-center items-center  ${
                  displaySearch
                    ? "hover:text-[#535353] cursor-pointer"
